        ...
        <form @submit.prevent="createReport">
            ...
            <div class="row g-3 mt-1">
                <div class="col-md-6 form-group">
                    ...
                    <textarea id="txt_descripcion_servicio" v-model="descripcion_servicio" rows="4" required></textarea>
                </div>
                <div class="col-md-6 form-group">
                    <label for="txt_informacion">Información:</label>
                    <textarea id="txt_informacion" v-model="informacion" rows="4" required></textarea>
                </div>
            </div>
            ...
            <div class="form-group mt-3">
                <h5>Anexos</h5>
                <div v-for="(anexo, index) in anexos" :key="index" class="row g-3 mb-2 align-items-end">
                    <div class="col-md-10">
                        <input
                            type="file"
